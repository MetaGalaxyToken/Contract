...
contract MetaGalaxy is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  string constant _name = "MetaGalaxy";
  string constant _symbol = "MGalaxy";
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0x098cCaF751cfB022CDC57bC61bcdaA5e2BE1b55c;
    devFeeReceiver = 0x520C1715d671173C9fC2E4405daD8Bdde39FD8b4;
  ...
  function BEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {        
